...
let URL = 'automation/v1/completions_finetunes/email_writer'
  ...
  return (
        <section id= "paraphraser">
          ...
          <div className='write_template'>
            <InputComponent title1= "Enter Content" placeholder1= "Requesting leave from the company befor 4 days"
