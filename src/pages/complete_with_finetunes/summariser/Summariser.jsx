...
let URL = 'automation/v1/completions_finetunes/summeriser'
  ...
  return (
        <section id= "paraphraser">
          ...
          <div className='write_template'>
            <InputComponent title1= "Enter Content" placeholder1= "Once upon a time there was a boy named Ram. He was very nice and used to help a lot of children around him. He got sick suddenly."
