...
let URL = 'automation/v1/completions_finetunes/sentence_expander'
  ...
  return (
        <section id= "paraphraser">
          ...
          <div className='write_template'>
            <InputComponent title1= "Enter Sentence" placeholder1= "Summer vacation clothing sale ic comming soon and I've been eager for a long time. "
