...
let URL = 'automation/v1/completions_finetunes/poem'
  ...
  return (
        <section id= "paraphraser">
          ...
          <div className='write_template'>
            <InputComponent title1= "Enter Title" placeholder1= "Cleaver Child"
                      onChange1= {handleOnChangeTitle} title2= "Enter Some words" placeholder2= "A young scientist was born in the city. He uses cool experiments to show off his mental abilities."
