...
let URL = 'automation/v1/completions_finetunes/creative_story'
        ...
        <section id= "paraphraser">
          ...
          <div className='write_template'>
            <InputComponent title1= "Enter Title" placeholder1= "Summer vacation clothing sale..."
                      onChange1= {handleOnChangeTitle} title2= "Enter Beginning of the story" placeholder2= "Summer vacation clothing sale..."
                      onChange2= {handleOnChangeStory} buttontext1= "Write" onClick1= {handleSubmit}/>
