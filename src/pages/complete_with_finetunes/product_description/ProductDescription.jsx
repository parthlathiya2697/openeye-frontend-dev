...
let URL = 'automation/v1/completions_finetunes/product_description'
  ...
  return (
        <section id= "paraphraser">
          ...
          <div className='write_template'>
            <InputComponent title1= "Enter Name" placeholder1= "Vision on AI"
                      onChange1= {handleOnChangeProductName} title2= "Enter Characteristics" placeholder2= "Machine Learning, Artificial Intelligence, Natural Language Processing, etc."
