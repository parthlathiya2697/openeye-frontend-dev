...
let URL = 'automation/v1/completions_fewshots/summeriser'
  ...
  return (
        <section id= "paraphraser">
          ...
          <div className='write_template'>
            <InputComponent title1= "Enter Content" placeholder1= "Summer vacation clothing sale was on and there was a large crowd that gathered all over the place. It became very difficult for me to find the appropriate slothings."
