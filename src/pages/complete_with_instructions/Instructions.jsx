...
const Instructions = () => {
	...
	const images_dict = importAll(require.context('../../assets/applications/complete_with_instructions', false, /\.(png|jpe?g|svg)$/));
			...
			<div className="application__content">
...

				{
					...
					return (
							...
							<Link key={index} to= {"/instructions_" +item + "/"} className='application__card card'>
