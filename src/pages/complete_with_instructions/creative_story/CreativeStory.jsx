...
let URL = 'automation/v1/completions_instructions/creative_story'
  ...
  return (
        <section id= "paraphraser">
          ...
          <div className='write_template'>
            <InputComponent title1= "Enter Title" placeholder1= "Clever Fox" onChange1= {handleOnChangeTitle}
              title2= "Enter Beginning of the Story" placeholder2= "Once in a forest lived a fox under the cave. It was very " onChange2= {handleOnChangeStory}
              buttontext1= "Write" onClick1= {handleSubmit}/>
