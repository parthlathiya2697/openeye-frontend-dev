...
let URL = 'automation/v1/completions_instructions/rephrase'
    ...
    <div className='BlogpostHashtag'>
          <section id= "paraphraser">
            ...
            <div className='write_template'>
              <InputComponent title1= "Enter Text" placeholder1= "Today I went to visit Vision on AI website and I was thrilled to see the Innovations that they've made."
