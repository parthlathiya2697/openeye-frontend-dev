...
let URL = 'automation/v1/completions_instructions/product_description'
        ...
        <section id= "paraphraser">
          ...
          <div className='write_template'>
            <InputComponent title1= "Enter Product Name" placeholder1= "Vision on AI"
                      onChange1= {handleOnChangeProductName} title2= "Enter Characteristics" placeholder2= "A Platform to generate Creative State of the Art writings by using Machines"
