...
let URL = 'automation/v1/completions_instructions/headline_'
...
const Headline = () => {
  ...
  return (
        <section id= "paraphraser">
          <h5>Headline </h5>
          <h2>Generate Awesome Taglines</h2>

          <div className='write_template'>
            <InputComponent title1= "Enter Description" placeholder1= "Amazing research in AI and Deep Learning"
